...
// //start
  // let query = 'INSERT INTO bgqgix3fbzndh3h9py0n.comandante ( nombres, apellidos, grado, telefono) VALUES("' + req.body.nombre + '","'+ req.body.apellidos + '","' + req.body.grado +'","'+ req.body.telefono +'")';
